...
module.exports = function(RED) {
    function ConfigureReputationOverrideNode(config) {
        ...
        node.on('input', function(msg) {
            ...
            const options = {
                ...
                port: 443,
                path: `/appservices/v6/orgs/${this.server.org_key}/reputations/overrides`,
                method: 'POST',
                headers: {
    ...
    RED.nodes.registerType("configure-reputation-override", ConfigureReputationOverrideNode);
}
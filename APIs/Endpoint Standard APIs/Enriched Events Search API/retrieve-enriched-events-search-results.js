...
module.exports = function(RED) {
    function RetrieveEnrichedEventsSearchNode(config) {
        ...
        node.on('input', function(msg) {
            ...
            const options = {
                ...
                port: 443,
                path: `/api/investigate/v2/orgs/${this.server.org_key}/enriched_events/search_jobs/${msg.payload}/results`,
                method: 'GET',
                headers: {
    ...
    RED.nodes.registerType('retrieve-enriched-events-search-results', RetrieveEnrichedEventsSearchNode);
}
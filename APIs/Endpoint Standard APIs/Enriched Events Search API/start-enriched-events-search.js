...
module.exports = function(RED) {
    function StartEnrichedEventsSearchNode(config) {
        ...
        node.on('input', function(msg) {
            ...
            const options = {
                ...
                port: 443,
                path: `/api/investigate/v2/orgs/${this.server.org_key}/${enriched_events/search_jobs}`,
                method: 'POST',
                headers: {
    ...
    RED.nodes.registerType("start-enriched-events-search", StartEnrichedEventsSearchNode);
}
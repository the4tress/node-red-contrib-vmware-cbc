...
module.exports = function(RED) {
    function GetTimeLimitsNode(config) {
        ...
        node.on('input', function(msg) {
            const options = {
                ...
                port: 443,
                path: '/api/investigate/v1/orgs/' + this.server.org_key + '/processes/limits',
                method: 'GET',
                headers: {
    ...
    RED.nodes.registerType('get-time-limits', GetTimeLimitsNode);
}

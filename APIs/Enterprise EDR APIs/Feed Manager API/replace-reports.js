...
module.exports = function(RED) {
    function ReplaceReportsNode(config) {
        ...
        node.on('input', function(msg) {
            ...
            const options = {
                ...
                port: 443,
                path: `/threathunter/feedmgr/v2/orgs/${this.server.org_key}/feeds/${msg.feed_id}/reports`,
                method: 'POST',
                headers: {
    ...
    RED.nodes.registerType("replace-reports", ReplaceReportsNode);
}
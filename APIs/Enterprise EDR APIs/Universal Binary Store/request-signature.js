...
module.exports = function(RED) {
    function RequestSignatureNode(config) {
        ...
        node.on('input', function(msg) {
            const options = {
                ...
                port: 443,
                path: `/ubs/v1/orgs/${this.server.org_key}/sha256/${msg.payload}/summary/signature`,
                method: 'GET',
                headers: {
    ...
    RED.nodes.registerType('request-signature', RequestSignatureNode);
}
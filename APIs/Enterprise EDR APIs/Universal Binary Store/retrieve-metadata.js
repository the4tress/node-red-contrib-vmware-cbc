...
module.exports = function(RED) {
    function RetrieveMetadataNode(config) {
        ...
        node.on('input', function(msg) {
            const options = {
                ...
                port: 443,
                path: `/ubs/v1/orgs/${this.server.org_key}/sha256/${msg.payload}/metadata`,
                method: 'GET',
                headers: {
    ...
    RED.nodes.registerType('retrieve-metadata', RetrieveMetadataNode);
}   